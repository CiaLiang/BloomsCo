            ...
            <div class="product-list">
                <div class="product">
                    ...
                    <map name="sneaker5-map">
                        <area href="http://localhost/Assignment/php/productDetails.php?product_id=56" coords="-1,1,997,998" shape="rect">
                    </map>
                ...
                <div class="product">
                    ...
                    <map name="short2-map">
                        <area href="http://localhost/Assignment/php/productDetails.php?product_id=53" coords="-1,1,997,998" shape="rect">
                    </map>
                ...
                <div class="product">
                    ...
                    <map name="cap3-map">
                        <area href="http://localhost/Assignment/php/productDetails.php?product_id=47" coords="-1,1,997,998" shape="rect">
                    </map>
                ...
                <div class="product">
                    ...
                    <map name="pants1-map">
                        <area href="http://localhost/Assignment/php/productDetails.php?product_id=48" coords="-1,1,997,998" shape="rect">
                    </map>
                ...
                <div class="product">
                    ...
                    <map name="sneaker1-map">
                        <area href="http://localhost/Assignment/php/productDetails.php?product_id=55" coords="-1,1,997,998" shape="rect">
                    </map>
                ...
                <div class="product">
                    ...
                    <map name="shirt1-map">
                        <area href="http://localhost/Assignment/php/productDetails.php?product_id=51" coords="-1,1,997,998" shape="rect">
                    </map>
                ...
                <div class="product">
                    ...
                    <map name="sneaker14-map">
                        <area href="http://localhost/Assignment/php/productDetails.php?product_id=52" coords="-1,1,997,998" shape="rect">
                    </map>
                ...
                <div class="product">
                    ...
                    <map name="short4-map">
                        <area href="http://localhost/Assignment/php/productDetails.php?product_id=44" coords="-1,1,997,998" shape="rect">
                    </map>
                ...
                <div class="product">
                    ...
                    <map name="pants4-map">
                        <area href="http://localhost/Assignment/php/productDetails.php?product_id=54" coords="-1,1,997,998" shape="rect">
                    </map>
                ...
                <div class="product">
                    ...
                    <map name="shirt5-map">
                        <area href="http://localhost/Assignment/php/productDetails.php?product_id=46" coords="-1,1,997,998" shape="rect">
                    </map>
